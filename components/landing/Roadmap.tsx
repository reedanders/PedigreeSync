...
export const Roadmap = () => {
  return (
    <Container>
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 py-10 sm:py-16">
        {/* Hero Section */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 sm:gap-16">
          ...
          <div className="lg:col-span-2 mb-16 sm:mb-32">
            <div className="grid grid-cols-1 sm:grid-cols-12 text-sm bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
              <a href="#phase-1" className="col-span-1 sm:col-span-12 border-b border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row items-start sm:items-center py-3 sm:py-4 px-3 sm:px-6 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer">
              ...
              <a href="#phase-2" className="col-span-1 sm:col-span-12 border-b border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row items-start sm:items-center py-3 sm:py-4 px-3 sm:px-6 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer">
              ...
              <a href="#phase-3" className="col-span-1 sm:col-span-12 border-b border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row items-start sm:items-center py-3 sm:py-4 px-3 sm:px-6 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer">
